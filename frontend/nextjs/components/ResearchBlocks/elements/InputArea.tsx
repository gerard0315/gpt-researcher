...
const InputArea: FC<TInputAreaProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <form
        className="mx-auto flex pt-2 pb-2 w-full items-start justify-between rounded-xl border border-gray-700/50 bg-gray-900/90 backdrop-blur-sm px-3 shadow-md relative overflow-hidden z-10"
        onSubmit={(e) => {
          e.preventDefault();
          if (reset) reset();
          handleSubmit(promptValue);
      ...
      >
        ...
        <textarea
          ...
          text-lg sm:text-xl min-h-[200px] resize-y relative z-10 bg-transparent"
          disabled={disabled}
          value={promptValue}
          required
          rows={8}
